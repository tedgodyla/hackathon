var Interaction = {
    ...
    initHandlers: function () {
        ...
        $(window).on('tp_scroll', function(){
            scrollTop = $(window).scrollTop();
            if (self.windowWidth > 500){
                self.imgParallaxScroll(scrollTop);
            }
        });
    },

    imgParallaxScroll: function (scrollTop){   
        var backgroundY = Math.round(scrollTop / 2);
        $('.hero').css('background-position', 'center '+ backgroundY +'px');
    },
